...
to_read = {'simple_superscript' : '^ %s ',
                ...
                'from_to' : '[ %s , blindtexespacioblindtex %s ] blindtexespacioblindtex ',
                'over' : '[ %s ] blindtexespacioblindtex ',
                'to' : 'to %s of ',
                'end' : 'end%s ',
                'linebreak' : 'linebreak',
